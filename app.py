...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://avnadmin:AVNS_Cd77dPj7YJ71Ed51xcF@pg-c5503df-safe-space.l.aivencloud.com:11268/defaultdb?sslmode=require'
db = SQLAlchemy(app)
